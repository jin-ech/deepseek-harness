...
> & {
  ...
  /** Delete a session (row menu action; opens confirmation dialog). */
...
export function WorkspaceBrowser({
  ...
  // Session delete dialog (same browser-owned pattern as workspace delete;
  // deleting is destructive — the log files are removed permanently).
