...
export const zh = {
  ...
  'delete.session.desc': '将永久删除“{name}”及其所有对话记录。此操作不可撤销。',
...
export const en = {
  ...
  'delete.session.desc': 'This permanently deletes “{name}” and all its conversation history. This action cannot be undone.',
