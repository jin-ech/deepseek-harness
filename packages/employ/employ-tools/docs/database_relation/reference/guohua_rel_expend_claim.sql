-- Table structure for guohua_rel_expend_claim
-- ----------------------------
DROP TABLE IF EXISTS `guohua_rel_expend_claim`;
CREATE TABLE `guohua_rel_expend_claim` (
...
) ENGINE=InnoDB AUTO_INCREMENT=8589 DEFAULT CHARSET=utf8mb4 COMMENT='财务管理系统支出确认表';
