-- Table structure for work_disability_evaluate_question_1500_0410
-- ----------------------------
DROP TABLE IF EXISTS `work_disability_evaluate_question_1500_0410`;
CREATE TABLE `work_disability_evaluate_question_1500_0410` (
