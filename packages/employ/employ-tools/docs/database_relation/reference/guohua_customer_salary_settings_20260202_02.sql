-- Table structure for guohua_customer_salary_settings_20260202_02
-- ----------------------------
DROP TABLE IF EXISTS `guohua_customer_salary_settings_20260202_02`;
CREATE TABLE `guohua_customer_salary_settings_20260202_02` (
...
) ENGINE=InnoDB AUTO_INCREMENT=4013 DEFAULT CHARSET=utf8mb4 COMMENT='客户信息管理配置表';
