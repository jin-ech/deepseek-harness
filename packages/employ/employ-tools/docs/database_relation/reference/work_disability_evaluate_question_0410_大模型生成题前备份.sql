-- Table structure for work_disability_evaluate_question_0410_大模型生成题前备份
-- ----------------------------
DROP TABLE IF EXISTS `work_disability_evaluate_question_0410_大模型生成题前备份`;
CREATE TABLE `work_disability_evaluate_question_0410_大模型生成题前备份` (
