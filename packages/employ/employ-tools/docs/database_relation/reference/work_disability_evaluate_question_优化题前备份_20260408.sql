-- Table structure for work_disability_evaluate_question_优化题前备份_20260408
-- ----------------------------
DROP TABLE IF EXISTS `work_disability_evaluate_question_优化题前备份_20260408`;
CREATE TABLE `work_disability_evaluate_question_优化题前备份_20260408` (
