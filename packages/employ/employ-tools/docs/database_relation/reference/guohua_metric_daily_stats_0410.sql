-- Table structure for guohua_metric_daily_stats_0410
-- ----------------------------
DROP TABLE IF EXISTS `guohua_metric_daily_stats_0410`;
CREATE TABLE `guohua_metric_daily_stats_0410` (
...
) ENGINE=InnoDB AUTO_INCREMENT=10999 DEFAULT CHARSET=utf8mb4 COMMENT='经营指标日报';
