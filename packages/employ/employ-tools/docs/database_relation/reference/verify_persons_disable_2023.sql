-- Table structure for verify_persons_disable_2023
-- ----------------------------
DROP TABLE IF EXISTS `verify_persons_disable_2023`;
CREATE TABLE `verify_persons_disable_2023` (
...
) ENGINE=InnoDB AUTO_INCREMENT=9766 DEFAULT CHARSET=utf8mb4 COMMENT='残联系统验证残疾人';
