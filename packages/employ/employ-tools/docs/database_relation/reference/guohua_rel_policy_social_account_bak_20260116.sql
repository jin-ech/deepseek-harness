-- Table structure for guohua_rel_policy_social_account_bak_20260116
-- ----------------------------
DROP TABLE IF EXISTS `guohua_rel_policy_social_account_bak_20260116`;
CREATE TABLE `guohua_rel_policy_social_account_bak_20260116` (
...
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8mb4 COMMENT='社保缴费比例动态配置表';
