-- Table structure for guohua_standard_service_product_copy1
-- ----------------------------
DROP TABLE IF EXISTS `guohua_standard_service_product_copy1`;
CREATE TABLE `guohua_standard_service_product_copy1` (
