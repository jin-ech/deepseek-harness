-- Table structure for guohua_metric_daily_stats
-- ----------------------------
DROP TABLE IF EXISTS `guohua_metric_daily_stats`;
CREATE TABLE `guohua_metric_daily_stats` (
  ...
  `unclaimed_service_amount` decimal(15,2) NOT NULL DEFAULT 0.00 COMMENT '未回款金额（营收合计）',
...
) ENGINE=InnoDB AUTO_INCREMENT=13289 DEFAULT CHARSET=utf8mb4 COMMENT='经营指标日报';
