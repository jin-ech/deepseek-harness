-- Table structure for base_guohua_department_new_bak-260113
-- ----------------------------
DROP TABLE IF EXISTS `base_guohua_department_new_bak-260113`;
CREATE TABLE `base_guohua_department_new_bak-260113` (
