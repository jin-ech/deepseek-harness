-- Table structure for guohua_rel_contract_sign_approve_files
-- ----------------------------
DROP TABLE IF EXISTS `guohua_rel_contract_sign_approve_files`;
CREATE TABLE `guohua_rel_contract_sign_approve_files` (
...
) ENGINE=InnoDB AUTO_INCREMENT=791 DEFAULT CHARSET=utf8mb4 COMMENT='合同提前启动批办附件表';
