-- Table structure for guohua_rel_policy_social_account
-- ----------------------------
DROP TABLE IF EXISTS `guohua_rel_policy_social_account`;
CREATE TABLE `guohua_rel_policy_social_account` (
  ...
  `company_fund_rate` varchar(32) DEFAULT NULL COMMENT '企业公积金比例5%-12%',
  `company_medicine_heavy_rate` varchar(32) DEFAULT NULL COMMENT '企业大病医疗比例',
  ...
  `is_payment_fund` tinyint(4) NOT NULL DEFAULT 0 COMMENT '企业是否交公积金 1是 0否',
  ...
  `is_social_security` tinyint(4) NOT NULL DEFAULT 0 COMMENT '企业是否承担个人社保 1是 0否',
...
) ENGINE=InnoDB AUTO_INCREMENT=51 DEFAULT CHARSET=utf8mb4 COMMENT='社保缴费比例动态配置表';
