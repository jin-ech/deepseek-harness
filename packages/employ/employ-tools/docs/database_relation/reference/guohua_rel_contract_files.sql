-- Table structure for guohua_rel_contract_files
-- ----------------------------
DROP TABLE IF EXISTS `guohua_rel_contract_files`;
CREATE TABLE `guohua_rel_contract_files` (
...
) ENGINE=InnoDB AUTO_INCREMENT=15776 DEFAULT CHARSET=utf8mb4 COMMENT='合同关联附件表';
