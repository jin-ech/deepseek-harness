-- Table structure for base_dict_xiaomi_persons_month
-- ----------------------------
DROP TABLE IF EXISTS `base_dict_xiaomi_persons_month`;
CREATE TABLE `base_dict_xiaomi_persons_month` (
...
) ENGINE=InnoDB AUTO_INCREMENT=40 DEFAULT CHARSET=utf8mb4 COMMENT='小米人员';
