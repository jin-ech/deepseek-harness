-- Table structure for work_disability_evaluate_question_0410_03_操作逻辑50题前备份
-- ----------------------------
DROP TABLE IF EXISTS `work_disability_evaluate_question_0410_03_操作逻辑50题前备份`;
CREATE TABLE `work_disability_evaluate_question_0410_03_操作逻辑50题前备份` (
...
) ENGINE=InnoDB AUTO_INCREMENT=1919 DEFAULT CHARSET=utf8mb4 COMMENT='残疾人职业能力测评题库';
