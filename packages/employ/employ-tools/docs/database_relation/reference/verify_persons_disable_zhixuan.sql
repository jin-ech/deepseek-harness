-- Table structure for verify_persons_disable_zhixuan
-- ----------------------------
DROP TABLE IF EXISTS `verify_persons_disable_zhixuan`;
CREATE TABLE `verify_persons_disable_zhixuan` (
...
) ENGINE=InnoDB AUTO_INCREMENT=9150 DEFAULT CHARSET=utf8mb4 COMMENT='残联系统验证残疾人';
