-- Table structure for base_permission_role_detail
-- ----------------------------
DROP TABLE IF EXISTS `base_permission_role_detail`;
CREATE TABLE `base_permission_role_detail` (
...
) ENGINE=InnoDB AUTO_INCREMENT=1411 DEFAULT CHARSET=utf8mb4 COMMENT='角色权限明细';
