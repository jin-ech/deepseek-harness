-- Table structure for guohua_call_center_ruoyun_agent
-- ----------------------------
DROP TABLE IF EXISTS `guohua_call_center_ruoyun_agent`;
CREATE TABLE `guohua_call_center_ruoyun_agent` (
  `agent_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '坐席id',
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COMMENT='七陌外呼坐席表';
