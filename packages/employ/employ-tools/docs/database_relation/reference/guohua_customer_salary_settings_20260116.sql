-- Table structure for guohua_customer_salary_settings_20260116
-- ----------------------------
DROP TABLE IF EXISTS `guohua_customer_salary_settings_20260116`;
CREATE TABLE `guohua_customer_salary_settings_20260116` (
  ...
  `company_medicine_heavy_rate` varchar(11) NOT NULL DEFAULT '' COMMENT '企业大病医疗',
  ...
  `company_salary` decimal(19,2) NOT NULL COMMENT '薪资',
...
) ENGINE=InnoDB AUTO_INCREMENT=3972 DEFAULT CHARSET=utf8mb4 COMMENT='客户信息管理配置表';
