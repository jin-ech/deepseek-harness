-- Table structure for work_disability_evaluate_question
-- ----------------------------
DROP TABLE IF EXISTS `work_disability_evaluate_question`;
CREATE TABLE `work_disability_evaluate_question` (
