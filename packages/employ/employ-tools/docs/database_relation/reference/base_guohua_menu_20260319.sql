-- Table structure for base_guohua_menu_20260319
-- ----------------------------
DROP TABLE IF EXISTS `base_guohua_menu_20260319`;
CREATE TABLE `base_guohua_menu_20260319` (
...
) ENGINE=InnoDB AUTO_INCREMENT=156 DEFAULT CHARSET=utf8mb4 COMMENT='国华内部系统菜单表';
