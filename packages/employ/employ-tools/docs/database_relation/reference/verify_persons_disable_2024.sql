-- Table structure for verify_persons_disable_2024
-- ----------------------------
DROP TABLE IF EXISTS `verify_persons_disable_2024`;
CREATE TABLE `verify_persons_disable_2024` (
...
) ENGINE=InnoDB AUTO_INCREMENT=13183 DEFAULT CHARSET=utf8mb4 COMMENT='残联系统验证残疾人';
