-- Table structure for guohua_activity_question_option
-- ----------------------------
DROP TABLE IF EXISTS `guohua_activity_question_option`;
CREATE TABLE `guohua_activity_question_option` (
  `question_option_id` int(11) NOT NULL AUTO_INCREMENT COMMENT '问题选项id',
...
) ENGINE=InnoDB AUTO_INCREMENT=476 DEFAULT CHARSET=utf8mb4 COMMENT='活动题目选项表';
