-- Table structure for base_dict_permissions_bak_20260731
-- ----------------------------
DROP TABLE IF EXISTS `base_dict_permissions_bak_20260731`;
CREATE TABLE `base_dict_permissions_bak_20260731` (
