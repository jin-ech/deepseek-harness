-- Table structure for base_dict_cost_type_bak_20260116
-- ----------------------------
DROP TABLE IF EXISTS `base_dict_cost_type_bak_20260116`;
CREATE TABLE `base_dict_cost_type_bak_20260116` (
...
) ENGINE=InnoDB AUTO_INCREMENT=117 DEFAULT CHARSET=utf8mb4 COMMENT='费用类别字典表';
