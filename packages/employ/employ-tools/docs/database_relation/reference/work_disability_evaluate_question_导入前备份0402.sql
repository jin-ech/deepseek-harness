-- Table structure for work_disability_evaluate_question_导入前备份0402
-- ----------------------------
DROP TABLE IF EXISTS `work_disability_evaluate_question_导入前备份0402`;
CREATE TABLE `work_disability_evaluate_question_导入前备份0402` (
...
) ENGINE=InnoDB AUTO_INCREMENT=482 DEFAULT CHARSET=utf8mb4 COMMENT='残疾人职业能力测评题库';
