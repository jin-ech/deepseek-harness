-- Table structure for guohua_dashboard_metric_bak260329
-- ----------------------------
DROP TABLE IF EXISTS `guohua_dashboard_metric_bak260329`;
CREATE TABLE `guohua_dashboard_metric_bak260329` (
...
) ENGINE=InnoDB AUTO_INCREMENT=125 DEFAULT CHARSET=utf8mb4 COMMENT='看板指标定义表：存储所有可用指标的元数据配置';
