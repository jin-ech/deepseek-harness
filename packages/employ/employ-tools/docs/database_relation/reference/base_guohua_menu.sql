-- Table structure for base_guohua_menu
-- ----------------------------
DROP TABLE IF EXISTS `base_guohua_menu`;
CREATE TABLE `base_guohua_menu` (
...
) ENGINE=InnoDB AUTO_INCREMENT=295 DEFAULT CHARSET=utf8mb4 COMMENT='国华内部系统菜单表';
